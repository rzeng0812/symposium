...
""",
        ...
        'collision_triggers': {
            ...
            'douglass_north': 'North\'s institutional history addresses path dependence; you address class power — these are competing explanations for the same phenomena',
        },
    },
